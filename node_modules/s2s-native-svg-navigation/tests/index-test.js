...
//These tests will simply determine it has the correct amount of children. Unlike some of the other SVG tests many of these have more than one path.
describe('s2s-svg-navigation tests', ()=>{
  ...
  it('renders ContactsIconSVG', () => {
    ...
    expect(wrapper.find('Path').length + wrapper.find('Circle').length + wrapper.find('Rect').length ).toEqual(4);
  });
