...
var S2SNativeBaseComponent = function (_React$Component) {
  _inherits(S2SNativeBaseComponent, _React$Component);

  function S2SNativeBaseComponent(props) {
    _classCallCheck(this, S2SNativeBaseComponent);

    return _possibleConstructorReturn(this, (S2SNativeBaseComponent.__proto__ || Object.getPrototypeOf(S2SNativeBaseComponent)).call(this, props));
  }

  _createClass(S2SNativeBaseComponent, [{
    key: 'getClassName',
    value: function getClassName() {
      ...
      if (typeof this.displayName === 'string') {
        ...
        console.warn('class missing displayName', _typeof(this.displayName), this.displayName, this.constructor, this.constructor && this.constructor.name, this);
        dName = 'undefined';
      }
    ...
    key: 'applyThemeStyle',
    value: function applyThemeStyle(styleName, styles) {
      // NOTE: the 'themes' object is imported (in case you are looking for where
      // it is defined)

      var componentName = this.getClassName().toLowerCase();
    ...
    key: 'getCompStyle',
    value: function getCompStyle(styleName) {
    ...
    value: function getStyle(styleName) {
      ...
      // build initial array
      var styleReturn = [].concat(this.getDefaultStyle(styleName, props, state)); //add object
      ...
      var compStyle = this.getCompStyle(styleName, props);
      if (compStyle) {
    ...
    key: 'getIntlText',
    value: function getIntlText(keyName, defaultMsg) {
      //console.log('Intl: ', this.getClassName(), keyName);
      var sMessage = defaultMsg;
      if (this.props.intl) {
        var intlMsg = this.props.intl.formatMessage({ "id": keyName });
        if (intlMsg != keyName) {
          sMessage = intlMsg;
        }
      }
...
exports.default = S2SNativeBaseComponent;
